...
var ProjectReportsComponent = /** @class */ (function () {
    function ProjectReportsComponent(translate, http, teamService, userService, projectService, authenticationService, exportAsService) {
        var _this = this;
        this.translate = translate;
        this.http = http;
                    ...
                    _this.projects.forEach(function (element) {
                        element.type = (function () {
                            try {
                                ...
                                if (Object(lodash__WEBPACK_IMPORTED_MODULE_14__["isNumber"])(element.type)) {
                                    return [element.type];
                                }
                                else {
                                    return [];
                        ...
                        element.hashtag = (function () {
                            try {
                                ...
                                if (Object(lodash__WEBPACK_IMPORTED_MODULE_14__["isNumber"])(element.hashtag)) {
    ...
    ProjectReportsComponent.prototype.openProjectModal = function () {
        this.isOpenProjectModal = true;
    };
    ProjectReportsComponent.prototype.closeProjectModal = function () {
        this.isOpenProjectModal = false;
    };
    ProjectReportsComponent.prototype.projectChange = function (event) {
        console.log('selected:', event);
    };
    ProjectReportsComponent.prototype.getProjects = function () {
        var _this = this;
        this.projectService.getProject().subscribe(function (data) {
            _this.projectsAll = data;
        });
    };
    ProjectReportsComponent.prototype.exportBillFiles = function () {
        var _this = this;
        if (this.selectedProjects && this.selectedProjects.id) {
            this.http.post(this.apiUrl + '/api/defect/export-project-bill', { project_id: this.selectedProjects.id }, { responseType: 'blob' })
                .subscribe(function (blob) {
                var link = document.createElement('a');
                var url = window.URL.createObjectURL(blob);
                link.href = url;
                link.download = _this.selectedProjects.project_name + '.xlsx';
                link.click();
                window.URL.revokeObjectURL(url);
                _this.isOpenProjectModal = false;
            });
        }
    };
