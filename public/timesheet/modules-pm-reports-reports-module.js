...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("::ng-deep .odd {\n  display: none;\n}\n\ntr.expanded-row td {\n  background-color: #f9f9f9;\n  border-top: none;\n}\n\n.fa {\n  color: #007bff;\n  font-size: 18px;\n}\n\n.fa:hover {\n  color: #0056b3;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
var SalaryReportsComponent = /** @class */ (function () {
    ...
    SalaryReportsComponent.prototype.getSalaryByUser = function () {
        ...
        this.exportTableData.forEach(function (user, index) {
            ...
            if (user.contract && user.contract.id) {
                ...
                user.salary_BHBB = user.salary_basic * 10.5 / 100;
                ...
                _this.totalSalary.total26 += (user.salary_basic * 0.5 / 100) > 234000 ? 234000 : (user.salary_basic * 0.5 / 100);
                ...
                _this.totalSalary.total30 += user.salary_basic * 32 / 100 - user.salary_BHBB;
                _this.totalSalary.total31 += user.salary_basic * 2 / 100;
                _this.totalSalary.total32 += user.salary_sum_of_sums + (user.salary_basic * 32 / 100 - user.salary_BHBB) + (user.salary_basic * 2 / 100);
            }
        });
    };
    ...
    SalaryReportsComponent.prototype.exportFilesSalary = function () {
        var _this = this;
        this.http.post(this.apiUrl + '/api/defect/export-salary', { month: this.month, data: this.exportTableData, workingInMonth: this.workingInMonth, settings: this.settings }, { responseType: 'blob' })
            .subscribe(function (blob) {
            var link = document.createElement('a');
            var url = window.URL.createObjectURL(blob);
            link.href = url;
