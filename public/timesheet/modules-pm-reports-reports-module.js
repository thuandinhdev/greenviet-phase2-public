...
var SalaryReportsComponent = /** @class */ (function () {
    ...
    SalaryReportsComponent.prototype.exportFilesSalary = function () {
        var _this = this;
        this.http.post(this.apiUrl + '/api/defect/export-salary', { data: this.exportTableData, workingInMonth: this.workingInMonth, settings: this.settings }, { responseType: 'blob' })
            .subscribe(function (blob) {
            var link = document.createElement('a');
            var url = window.URL.createObjectURL(blob);
            link.href = url;
